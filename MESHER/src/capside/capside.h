...
class Vdb : public File{
	...
	public:
		...
		void ReadCompleteFile( int fold_id, double align2Z_00, double align2Z_01, double align2Z_02, double align2Z_10, double align2Z_11, double align2Z_12, double align2Z_20, double align2Z_21, double align2Z_22, bool mesh_rotated_atoms  );
		int ReadLine( char* rotated_file, double align2Z_00, double align2Z_01, double align2Z_02, double align2Z_10, double align2Z_11, double align2Z_12, double align2Z_20, double align2Z_21, double align2Z_22, bool mesh_rotated_atoms );
